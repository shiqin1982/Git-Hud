...
namespace ZXQX
{
    public partial class Form1 : Form
    {
        ...
        public class Curve2D
        {
            ...
            private float fltTension = 0.5f;//张力系数
            private string strTitle = "曲线图"; //标题
            private string strXAxisText = "月份"; //X轴说明文字
            private string strYAxisText = "万元"; //Y轴说明文字
            //private string[] strsKeys = new string[] { "2016-02-01", "2016-02-02", "2016-02-03", "2016-02-04", "2016-02-05", "2016-02-06", "2016-02-07", "2016-02-08", "2016-02-09", "2016-02-10", "2016-02-11", "2016-02-12", "2016-02-13", "2016-02-14", "2016-02-15", "2016-02-16", "2016-02-17", "2016-02-18", "2016-02-19", "2016-02-20", "2016-02-21", "2016-02-22", "2016-02-23", "2016-02-24", "2016-02-25", "2016-02-26", "2016-02-27", "2016-02-28", "2016-02-29", "2016-02-30", "2016-02-31", "2016-02-32" }; //键
            //private float[] fltsValues = new float[] { 20.0f, 30.0f, 50.0f, 55.4f, 21.6f, 12.8f, 200f, 2000f, 78.2f, 56.4f, 45.8f, 66.5f, 20.0f, 30.0f, 50.0f, 55.4f, 21.6f, 12.8f, 200f, 36.4f, 78.2f, 56.4f, 45.8f, 66.5f, 21.6f, 12.8f, 200f, 36.4f, 78.2f, 56.4f, 45.8f, 66.5f }; //值
            private string[] strsKeys = new string[] { "2016-02-01", "2016-02-02", "2016-02-03", "2016-02-04", "2016-02-05", "2016-02-06", "2016-02-07", "2016-02-08", "2016-02-09", "2016-02-10" }; //键
            private float[] fltsValues = new float[] { 20.0f, 30.0f, 50.0f, 55.4f, 21.6f, 12.8f, 200f, 2000f, 78.2f, 56.4f }; //值
...
                {
                    bjGraphics.DrawString(YAxisText[i].ToString(), new Font("宋体", FontSize), new SolidBrush(AxisTextColor), fltX, fltY);
...
                //Point[] CurvePoint = new Point[Keys.Length];
                float keys = 0;
                float values = 0;
 
