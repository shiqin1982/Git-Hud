...
using tomoral.DBUtility;//Please add references
namespace tomoral.DAL
{
    /// <summary>
    /// 数据访问类:CRM_Customer
    /// </summary>
    public partial class CRM_Customer
    {
        ...
        public tomoral.Model.CRM_Customer GetModel(int id)
        {
            ...
            tomoral.Model.CRM_Customer model = new tomoral.Model.CRM_Customer();
        ...
        public bool ToImport()
        {
            ...
            strSql0.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [isDelete]=0 WHERE [isDelete] is null");
            strSql1.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [industry_id] = (select id from Param_SysParam where params_name=CRM_Customer.industry and parentid=8)");
            strSql2.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [CustomerType_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerType and parentid=1)");
            strSql3.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [CustomerLevel_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerLevel and parentid=2)");
            strSql4.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [CustomerSource_id] = (select id from Param_SysParam where params_name=CRM_Customer.CustomerSource and parentid=3)");
            strSql5.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [Provinces_id] = (select id from Param_City where City=CRM_Customer.Provinces)");
            strSql6.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [City_id] = (select id from Param_City where City=CRM_Customer.City)");
            strSql7.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [Department_id] = (select id from hr_department where d_name=CRM_Customer.Department)");
            strSql8.Append("UPDATE [TMCRM].[dbo].[CRM_Customer] SET [Employee_id] = (select ID from hr_employee where name=CRM_Customer.Employee)");
