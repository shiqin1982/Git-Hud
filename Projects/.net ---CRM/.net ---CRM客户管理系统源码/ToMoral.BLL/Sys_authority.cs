...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Sys_authority dal=new tomoral.DAL.Sys_authority();
		...
		/// 增加一条数据
		/// </summary>
		public void Add(tomoral.Model.Sys_authority model)
		{
			dal.Add(model);
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Sys_authority model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Sys_authority GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			return dal.GetModel();
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Sys_authority GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (tomoral.Model.Sys_authority)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Sys_authority> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Sys_authority> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Sys_authority> modelList = new List<tomoral.Model.Sys_authority>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Sys_authority model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Sys_authority();
