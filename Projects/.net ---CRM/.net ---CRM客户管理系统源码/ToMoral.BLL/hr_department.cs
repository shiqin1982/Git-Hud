...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.hr_department dal=new tomoral.DAL.hr_department();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.hr_department model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.hr_department model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.hr_department GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.hr_department GetModelByCache(int id)
		{
			...
			return (tomoral.Model.hr_department)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_department> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_department> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.hr_department> modelList = new List<tomoral.Model.hr_department>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.hr_department model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.hr_department();
