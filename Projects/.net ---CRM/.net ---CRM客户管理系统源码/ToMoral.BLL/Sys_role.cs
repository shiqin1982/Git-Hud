...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Sys_role dal=new tomoral.DAL.Sys_role();
		public Sys_role()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.Sys_role model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Sys_role model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Sys_role GetModel(int RoleID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Sys_role GetModelByCache(int RoleID)
		{
			...
			return (tomoral.Model.Sys_role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Sys_role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Sys_role> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Sys_role> modelList = new List<tomoral.Model.Sys_role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Sys_role model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Sys_role();
