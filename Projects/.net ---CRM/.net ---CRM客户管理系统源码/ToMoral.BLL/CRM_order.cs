...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.CRM_order dal=new tomoral.DAL.CRM_order();
		public CRM_order()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.CRM_order model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.CRM_order model)
		{
        ...
        /// 批量
        /// </summary>
        public bool Update_batch(tomoral.Model.CRM_order model)
        {
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.CRM_order GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.CRM_order GetModelByCache(int id)
		{
			...
			return (tomoral.Model.CRM_order)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_order> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_order> modelList = new List<tomoral.Model.CRM_order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_order model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_order();
