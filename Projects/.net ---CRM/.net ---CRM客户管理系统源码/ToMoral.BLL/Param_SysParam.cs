...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Param_SysParam dal=new tomoral.DAL.Param_SysParam();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.Param_SysParam model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Param_SysParam model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Param_SysParam GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Param_SysParam GetModelByCache(int id)
		{
			...
			return (tomoral.Model.Param_SysParam)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Param_SysParam> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Param_SysParam> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Param_SysParam> modelList = new List<tomoral.Model.Param_SysParam>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Param_SysParam model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Param_SysParam();
