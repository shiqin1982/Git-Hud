...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.CRM_product_category dal=new tomoral.DAL.CRM_product_category();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.CRM_product_category model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.CRM_product_category model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.CRM_product_category GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.CRM_product_category GetModelByCache(int id)
		{
			...
			return (tomoral.Model.CRM_product_category)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_product_category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_product_category> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_product_category> modelList = new List<tomoral.Model.CRM_product_category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_product_category model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_product_category();
