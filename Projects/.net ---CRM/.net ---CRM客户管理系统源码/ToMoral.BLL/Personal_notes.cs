...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Personal_notes dal=new tomoral.DAL.Personal_notes();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.Personal_notes model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Personal_notes model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Personal_notes GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Personal_notes GetModelByCache(int id)
		{
			...
			return (tomoral.Model.Personal_notes)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Personal_notes> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Personal_notes> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Personal_notes> modelList = new List<tomoral.Model.Personal_notes>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Personal_notes model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Personal_notes();
