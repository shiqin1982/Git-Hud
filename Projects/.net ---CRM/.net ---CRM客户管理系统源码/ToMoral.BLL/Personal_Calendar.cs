...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Personal_Calendar dal=new tomoral.DAL.Personal_Calendar();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.Personal_Calendar model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Personal_Calendar model)
		{
			return dal.Update(model);
		}

        public bool quickUpdate(tomoral.Model.Personal_Calendar model)
        {
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Personal_Calendar GetModel(int Id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Personal_Calendar GetModelByCache(int Id)
		{
			...
			return (tomoral.Model.Personal_Calendar)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Personal_Calendar> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Personal_Calendar> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Personal_Calendar> modelList = new List<tomoral.Model.Personal_Calendar>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Personal_Calendar model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Personal_Calendar();
