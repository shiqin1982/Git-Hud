...
namespace tomoral.BLL
{
    ...
    {
        private readonly tomoral.DAL.CRM_receive dal = new tomoral.DAL.CRM_receive();
        public CRM_receive()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(tomoral.Model.CRM_receive model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(tomoral.Model.CRM_receive model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public tomoral.Model.CRM_receive GetModel(int id)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public tomoral.Model.CRM_receive GetModelByCache(int id)
        {
            ...
            return (tomoral.Model.CRM_receive)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<tomoral.Model.CRM_receive> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<tomoral.Model.CRM_receive> DataTableToList(DataTable dt)
        {
            List<tomoral.Model.CRM_receive> modelList = new List<tomoral.Model.CRM_receive>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                tomoral.Model.CRM_receive model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new tomoral.Model.CRM_receive();
