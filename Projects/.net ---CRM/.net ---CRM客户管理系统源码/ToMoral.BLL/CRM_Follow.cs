...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.CRM_Follow dal=new tomoral.DAL.CRM_Follow();
		public CRM_Follow()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.CRM_Follow model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.CRM_Follow model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.CRM_Follow GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.CRM_Follow GetModelByCache(int id)
		{
			...
			return (tomoral.Model.CRM_Follow)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_Follow> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_Follow> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_Follow> modelList = new List<tomoral.Model.CRM_Follow>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_Follow model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_Follow();
        ...
        {
            return dal.Compared_follow(dt1, dt2);
        }
        /// <summary>
        /// 员工分析
        /// </summary>
        ...
        {
            return dal.Compared_empcusfollow(dt1, dt2, idlist);
        }
