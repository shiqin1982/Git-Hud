...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.CRM_invoice dal=new tomoral.DAL.CRM_invoice();
		public CRM_invoice()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.CRM_invoice model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.CRM_invoice model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.CRM_invoice GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.CRM_invoice GetModelByCache(int id)
		{
			...
			return (tomoral.Model.CRM_invoice)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_invoice> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_invoice> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_invoice> modelList = new List<tomoral.Model.CRM_invoice>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_invoice model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_invoice();
