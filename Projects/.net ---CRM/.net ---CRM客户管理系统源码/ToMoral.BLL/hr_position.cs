...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.hr_position dal=new tomoral.DAL.hr_position();
		public hr_position()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.hr_position model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.hr_position model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.hr_position GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.hr_position GetModelByCache(int id)
		{
			...
			return (tomoral.Model.hr_position)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_position> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_position> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.hr_position> modelList = new List<tomoral.Model.hr_position>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.hr_position model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.hr_position();
