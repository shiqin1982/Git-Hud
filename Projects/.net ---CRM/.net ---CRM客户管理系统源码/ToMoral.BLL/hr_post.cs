...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.hr_post dal=new tomoral.DAL.hr_post();
		public hr_post()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.hr_post model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.hr_post model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.hr_post GetModel(int post_id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.hr_post GetModelByCache(int post_id)
		{
			...
			return (tomoral.Model.hr_post)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_post> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.hr_post> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.hr_post> modelList = new List<tomoral.Model.hr_post>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.hr_post model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.hr_post();
        ...
        /// 更新岗位人员
        /// </summary>
        public bool UpdatePostEmp(tomoral.Model.hr_post model)
        {
