...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.CRM_contract dal=new tomoral.DAL.CRM_contract();
		public CRM_contract()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(tomoral.Model.CRM_contract model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.CRM_contract model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.CRM_contract GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.CRM_contract GetModelByCache(int id)
		{
			...
			return (tomoral.Model.CRM_contract)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_contract> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_contract> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_contract> modelList = new List<tomoral.Model.CRM_contract>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_contract model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_contract();
        ...
        {
            return dal.Compared_empcuscontract(dt1, dt2, idlist);
        }
