...
namespace tomoral.BLL
{
    ...
    {
        private readonly tomoral.DAL.hr_employee dal = new tomoral.DAL.hr_employee();
        public hr_employee()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(tomoral.Model.hr_employee model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(tomoral.Model.hr_employee model)
        {
        ...
        /// 得到一个对象实体
        /// </summary>
        public tomoral.Model.hr_employee GetModel(int ID)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public tomoral.Model.hr_employee GetModelByCache(int ID)
        {
            ...
            return (tomoral.Model.hr_employee)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<tomoral.Model.hr_employee> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<tomoral.Model.hr_employee> DataTableToList(DataTable dt)
        {
            List<tomoral.Model.hr_employee> modelList = new List<tomoral.Model.hr_employee>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                tomoral.Model.hr_employee model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new tomoral.Model.hr_employee();
        ...
        /// 更新岗位
        /// </summary>
        public bool UpdatePost(tomoral.Model.hr_employee model)
        {
        ...
        /// 更新密码
        /// </summary>
        public bool changepwd(tomoral.Model.hr_employee model)
        {
        ...
        /// <returns></returns>
        public bool PersonalUpdate(tomoral.Model.hr_employee model)
        {
        ...
        /// 更新客户，订单，合同，收款，开票 人员
        /// </summary>
        public bool UpdateCOCRI(tomoral.Model.hr_employee model)
        {
