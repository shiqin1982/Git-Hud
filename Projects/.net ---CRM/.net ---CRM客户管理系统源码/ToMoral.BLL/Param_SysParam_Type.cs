...
namespace tomoral.BLL
{
	...
	{
		private readonly tomoral.DAL.Param_SysParam_Type dal=new tomoral.DAL.Param_SysParam_Type();
		...
		/// 增加一条数据
		/// </summary>
		public void Add(tomoral.Model.Param_SysParam_Type model)
		{
			dal.Add(model);
		}
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(tomoral.Model.Param_SysParam_Type model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public tomoral.Model.Param_SysParam_Type GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			return dal.GetModel();
		}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public tomoral.Model.Param_SysParam_Type GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			...
			return (tomoral.Model.Param_SysParam_Type)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Param_SysParam_Type> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.Param_SysParam_Type> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.Param_SysParam_Type> modelList = new List<tomoral.Model.Param_SysParam_Type>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.Param_SysParam_Type model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.Param_SysParam_Type();
