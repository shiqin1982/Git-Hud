...
namespace tomoral.BLL
{
	...
	public partial class CRM_Contact
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_Contact> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<tomoral.Model.CRM_Contact> DataTableToList(DataTable dt)
		{
			List<tomoral.Model.CRM_Contact> modelList = new List<tomoral.Model.CRM_Contact>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				tomoral.Model.CRM_Contact model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new tomoral.Model.CRM_Contact();
