...
<head>
    ...
    <script type="text/javascript">
        ...
        function initselect() {
            ...
            i = $("#T_industry").ligerComboBox({ width: 196, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=8&rnd=" + Math.random() });
        ...
        function loadForm(oaid) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_employee_val").val(obj.Employee_id);
                    $("#T_employee1").val(obj.Employee);
                    $("#T_dep").val(obj.Department);
                    $("#T_dep_val").val(obj.Department_id);
