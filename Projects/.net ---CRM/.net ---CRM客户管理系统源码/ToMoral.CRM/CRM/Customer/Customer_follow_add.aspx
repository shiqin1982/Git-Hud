...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("form").ligerForm();
            $("#T_followtype").ligerComboBox({ width: 196, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=4&rnd=" + Math.random() })
            if (getparastr("fid")) {
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_followtype").ligerGetComboBoxManager().selectValue(obj.Follow_Type_id);
                }
            });
