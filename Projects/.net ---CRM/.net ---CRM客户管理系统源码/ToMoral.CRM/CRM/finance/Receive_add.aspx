...
<head >
    ...
    <script type="text/javascript">
        ...
        function initcombo() {
            ...
            d = $('#T_invoice_type').ligerComboBox({ width: 182, url: "../../data/Param_SysParam.ashx?Action=combo&parentid=5&rnd=" + Math.random() });
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#T_employee").val("【" + obj.C_depname + "】" + obj.C_empname);
                    $("#T_employee1").val(obj.C_empname);
                    $("#T_employee_val").val(obj.C_empid);
                    $("#T_dep").val(obj.C_depname);
                    $("#T_dep_val").val(obj.C_depid);
                }
            });
        }
        ...
        function f_selectContactOK(item, dialog) {
            ...
            $("#T_employee").val("【" + data.dname + "】" + data.name);
            $("#T_employee1").val(data.name);
            $("#T_employee_val").val(data.ID);
            $("#T_dep").val(data.dname);
            $("#T_dep_val").val(data.d_id);
            dialog.close();
        }
