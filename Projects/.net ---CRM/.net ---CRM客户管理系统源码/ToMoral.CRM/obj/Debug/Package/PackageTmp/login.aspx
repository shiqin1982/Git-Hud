...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            delCookie("tmcrm_show_wellcome")
            if (getCookie("tmcrm_uid") && getCookie("tmcrm_uid") != null)
                $("#T_uid").val(getCookie("tmcrm_uid"))
                        ...
                        if (typeof (result) == "number") {
                            switch (result) {
                                ...
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    SetCookie("tmcrm_uid", uid, 30);
                                    SetCookie("tm_crm_show_wellcome", "1");
    ...
    <form id="form1" name="form1">
        <div style="width: 731px; margin-left: 50px; margin-top: 200px;">
            <table id="__01" width="732" height="388" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td rowspan="6">
                      <img src="images/logo/logo.png" width="234" alt="至德CRM"/></td>
                ...
                <tr>
                    <td colspan="5" width="163" height="29" class="auto-style1">v1.15</td>
