...
<head>
    ...
    <script type="text/javascript">
        ...
        //    if (row) {
        //        top.jQuery.ligerDialog.open({ width: 770, height: 490, title: "发票详情", url: "CRM/finance/invoice_add.aspx?orderid=" + row.order_id + "&invoiceid=" + row.id, buttons: [{ text: '关闭', onclick: function (item, dialog) { dialog.close(); } }] });
        //    } else {
