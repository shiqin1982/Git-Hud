...
<body style="margin:5px 5px 5px 5px">
    ...
    <div>
        <table class="bodytable0" align="center" border="0" cellpadding="3" cellspacing="1" 
            ...
            <tr>
                <td height="23" width="70px" class="style1" ><div align="left" style="width: 61px">
                    角色名称：</div></td>
                <td height="23" class="style1" >
                    <div style="float:left; height: 20px;">
                        <input type="text" id="T_role"  name="T_role"  ltype="text" ligerui="{width:180}" 
            ...
            <tr>
                ...
                <td >
                        <div style="float:left; height: 20px;">
                        <input type="text" id="T_RoleOrder" name="T_RoleOrder"  ltype='spinner' ligerui="{type:'int',width:180}" value="20"/>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="vertical-align:top">
                    ...
                    <div align="left" style="width: 62px">角色描述：</div></td>
                <td >
