...
<head>
    ...
    <script type="text/javascript">
        ...
        function getsysinfo()
        {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    document.title = rows[0].sys_value + "CRM客户关系管理系统-俊逸";
        ...
        //    if (getCookie("tm_crm_show_wellcome") == 1 || item == 1) {
        //        var dialog = $.ligerDialog.open({
        //            url: "welcome.htm", width: 800, height: 500, title: "欢迎使用俊逸CRM系统", buttons: [
        //                    {
        //                        text: '关闭', onclick: function (item, dialog) {
        //                            dialog.close();
        //                        }
        ...
        //            ], isResize: true, timeParmName: 'a'
        //        });
        //        SetCookie("tm_crm_show_wellcome", "2");
        //    }
        //}
...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <div style="background: #d2e2f2; height: 74px; overflow: hidden;">
            <div style="height: 47px; margin: 0; padding: 0;">
                <div style="width: 278px; float: left;">
                        ...
                        <img id="logo" alt="" src="Images/logo/logo.png" style="height: 42px; margin-left: 5px; margin-top: 2px;" />
        ...
        <div id="layout1" style="width: 100%">
            ...
            <div position="bottom" style="width:100%; height:2px;">
            </div>
        </div>
    </form>
</body>
