...
namespace tomoral.CRM
{
    public class Global : System.Web.HttpApplication
    {
        ...
        void Application_Error(object sender, EventArgs e)
        {
            ...
            {
                tomoral.BLL.Sys_log_Err ssle = new tomoral.BLL.Sys_log_Err();
                tomoral.Model.Sys_log_Err model = new tomoral.Model.Sys_log_Err();

                model.Err_typeid = 2;
                model.Err_type = "CRM系统";
                model.Err_time = DateTime.Now;
                model.Err_url = tomoral.Common.PageValidate.InputText(Request.Url.ToString(), 500);
                model.Err_message = tomoral.Common.PageValidate.InputText(objErr.Message, int.MaxValue);
                model.Err_source = tomoral.Common.PageValidate.InputText(objErr.Source, 500);
                model.Err_trace = tomoral.Common.PageValidate.InputText(objErr.StackTrace, int.MaxValue);
                ...
                {
                    if (tomoral.Common.PageValidate.IsNumber(CoockiesID))
                    {
