...
namespace tomoral.CRM.Data
{
    ...
    public class CRM_order : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.Model.CRM_order model = new tomoral.Model.CRM_order();
            ...
            if (request["Action"] == "save")
            {
                ...
                tomoral.Model.CRM_order_details modeldel = new tomoral.Model.CRM_order_details();
            ...
            if (request["Action"] == "del")
            {
                ...
                tomoral.BLL.CRM_invoice invoice = new tomoral.BLL.CRM_invoice();
                tomoral.BLL.CRM_receive receive = new tomoral.BLL.CRM_receive();
