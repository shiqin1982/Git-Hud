...
namespace tomoral.CRM.Data
{
    ...
    public class CRM_product : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.CRM_product ccp = new tomoral.BLL.CRM_product();
            tomoral.Model.CRM_product model = new tomoral.Model.CRM_product();
            ...
            if (request["Action"] == "del")
            {
                ...
                tomoral.BLL.CRM_order_details ccod = new tomoral.BLL.CRM_order_details();
