...
namespace tomoral.CRM.Data
{
    ...
    public class _base : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                tomoral.BLL.Sys_online sol = new tomoral.BLL.Sys_online();
                tomoral.Model.Sys_online model = new tomoral.Model.Sys_online();
            ...
            {
                string dt = tomoral.Common.DataToJson.DataToJSON(dsemp);
            ...
            if (request["Action"] == "GetOnline")
            {
                ...
                context.Response.Write(tomoral.Common.GetGridJSON.DataTableToJSON(sol.GetAllList().Tables[0]));
            }
            if (request["Action"] == "GetIcons")
            {
                try
                {
                    ...
                    tomoral.Common.ObjectListToJSON objtojson = new tomoral.Common.ObjectListToJSON();
