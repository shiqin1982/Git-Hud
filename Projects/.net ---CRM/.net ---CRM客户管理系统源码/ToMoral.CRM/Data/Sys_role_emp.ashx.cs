...
namespace tomoral.CRM.Data
{
    ...
    public class Sys_role_emp : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.Model.Sys_role_emp model = new tomoral.Model.Sys_role_emp();
            ...
            if (request["Action"] == "add")
            {
                ...
                string empids = tomoral.Common.PageValidate.InputText(request["empids"], int.MaxValue);
            ...
            if (request["Action"] == "emplist")
            {
                ...
                string dt = tomoral.Common.GetGridJSON.DataTableToJSON1(dsemp.Tables[0], Total);
