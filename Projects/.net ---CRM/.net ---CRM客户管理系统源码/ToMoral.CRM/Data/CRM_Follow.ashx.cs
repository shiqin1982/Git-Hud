...
namespace tomoral.CRM.Data
{
    ...
    public class CRM_Follow : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.Model.CRM_Follow model = new tomoral.Model.CRM_Follow();
            ...
            if (request["Action"] == "save")
            {
                ...
                {
                    tomoral.BLL.Personal_Calendar calendar = new tomoral.BLL.Personal_Calendar();
                    tomoral.Model.Personal_Calendar modelcalendar = new tomoral.Model.Personal_Calendar();
            ...
            {
                DataSet ds = follow.GetList("id=" + int.Parse(request["fid"]) + DataAuth(emp_id.ToString()));
