        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (request["Action"] == "save")
            {
                ...
                else
                {
                    ...
                    model.Create_name = tomoral.Common.PageValidate.InputText(empname, 255);
                    int customerid = customer.Add(model);

                    tomoral.BLL.CRM_Contact contact = new tomoral.BLL.CRM_Contact();
                    tomoral.Model.CRM_Contact modelcontact = new tomoral.Model.CRM_Contact();
                    ...
                    modelcontact.C_email = tomoral.Common.PageValidate.InputText(request["T_email"], 255);
            ...
            {
                DataSet ds = customer.GetList("id=" + int.Parse(request["cid"]) + DataAuth(emp_id.ToString()));
            ...
            if (request["Action"] == "count")
            {
                ...
                tomoral.BLL.CRM_Contact contact = new tomoral.BLL.CRM_Contact();
                tomoral.BLL.CRM_contract contract = new tomoral.BLL.CRM_contract();
            ...
            if (request["Action"] == "Compared_empcusadd")
            {
                ...
                tomoral.BLL.hr_post post = new tomoral.BLL.hr_post();
                ...
                if (dspost.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dspost.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (i < dspost.Tables[0].Rows.Count - 1)
                            emplist += ",";
                    }
                    emplist += ")";
                }
            ...
            if (request["Action"] == "import")
            {
                ...
                string connectionString = tomoral.DBUtility.PubConstant.ConnectionString;
                ...
                if (dsemp.Tables[0].Rows[0]["uid"].ToString() != "admin")
                {
                    ...
                    switch (arr[0])
                    {
                        ...
                        case "dep":
                            ...
                            break;
                        case "depall":
                            tomoral.BLL.hr_department dep = new tomoral.BLL.hr_department();
