...
namespace tomoral.CRM.Data
{
    ...
    public class Param_SysParam : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.Param_SysParam psp = new tomoral.BLL.Param_SysParam();
            tomoral.Model.Param_SysParam model = new tomoral.Model.Param_SysParam();
            ...
            {
                tomoral.BLL.Param_SysParam_Type cpst = new tomoral.BLL.Param_SysParam_Type();
