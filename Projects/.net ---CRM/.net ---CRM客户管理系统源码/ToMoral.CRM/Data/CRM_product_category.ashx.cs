...
namespace tomoral.CRM.Data
{
    ...
    public class CRM_product_category : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.CRM_product_category ccpc = new tomoral.BLL.CRM_product_category();
            tomoral.Model.CRM_product_category model = new tomoral.Model.CRM_product_category();
            ...
            if (request["Action"] == "save")
            {
                ...
                model.product_category = tomoral.Common.PageValidate.InputText(request["T_category_name"], 250);
                model.product_icon = tomoral.Common.PageValidate.InputText(request["T_category_icon"], 250);
            ...
            if (request["Action"] == "grid")
            {
                ...
                {  
                    ...
                    dt = tomoral.Common.GetGridJSON.DataTableToJSON1(ds.Tables[0], Total);
                }
            ...
            if (request["Action"] == "del")
            {
                ...
                tomoral.BLL.CRM_product product = new tomoral.BLL.CRM_product();
