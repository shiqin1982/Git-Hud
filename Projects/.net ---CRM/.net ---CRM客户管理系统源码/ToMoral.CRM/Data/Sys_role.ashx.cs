...
namespace tomoral.CRM.Data
{
    ...
    public class Sys_role : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.Sys_role role = new tomoral.BLL.Sys_role();
            tomoral.Model.Sys_role model = new tomoral.Model.Sys_role();
            ...
            if (request["Action"] == "SysSave")
            {
                ...
                else
                {
                    ...
                    tomoral.BLL.Sys_data_authority auth = new tomoral.BLL.Sys_data_authority();
                    tomoral.Model.Sys_data_authority modelsda = new tomoral.Model.Sys_data_authority();
            ...
            {
                DataSet ds1 = role.GetList(" RoleName='" + tomoral.Common.PageValidate.InputText(request["T_role"], 250) + "'");
            ...
            if (request["Action"] == "del")
            {
                ...
                //角色下员工删除
                tomoral.BLL.Sys_role_emp rm = new tomoral.BLL.Sys_role_emp();
            ...
            if (request["Action"] == "getauth")
            {
                ...
                tomoral.Model.Sys_authority modelauth = new tomoral.Model.Sys_authority();
                modelauth.Role_id = int.Parse(sa.role_id);
                modelauth.App_ids = sa.app;
                modelauth.Menu_ids = sa.menu;
                modelauth.Button_ids = sa.btn;

                tomoral.BLL.Sys_authority sysau = new tomoral.BLL.Sys_authority();
