...
namespace tomoral.CRM.Data
{
    ...
    public class Param_City : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.Param_City pc = new tomoral.BLL.Param_City();
            tomoral.Model.Param_City model = new tomoral.Model.Param_City();
            ...
            {
                model.City = tomoral.Common.PageValidate.InputText(request["T_City"], 255);
            ...
            if (request["Action"] == "del")
            {
                ...
                tomoral.BLL.CRM_Customer cus = new tomoral.BLL.CRM_Customer();
