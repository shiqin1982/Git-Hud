        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (request["Action"] == "grid")
            {
                ...
                if (!string.IsNullOrEmpty(request["stype"]))
                    serchtext += " and EventType = '" + tomoral.Common.PageValidate.InputText(request["stype"], 255) + "'";

                if (!string.IsNullOrEmpty(request["sstart"]))
                    serchtext += " and EventDate >= '" + tomoral.Common.PageValidate.InputText(request["sstart"], 255) + "'";
                ...
                {
                    string stext = tomoral.Common.PageValidate.InputText(request["stext"], 10000);
