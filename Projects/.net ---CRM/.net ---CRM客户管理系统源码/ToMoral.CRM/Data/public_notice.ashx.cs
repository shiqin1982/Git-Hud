...
namespace tomoral.CRM.Data
{
    ...
    public class public_notice : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.public_notice notice = new tomoral.BLL.public_notice();
            tomoral.Model.public_notice model = new tomoral.Model.public_notice();
            ...
            if (request["Action"] == "save")
            {
                ...
                {
                    if (!tomoral.Common.PageValidate.IsNumber(nid))
                    {
                        nid = "-1";
                    }
