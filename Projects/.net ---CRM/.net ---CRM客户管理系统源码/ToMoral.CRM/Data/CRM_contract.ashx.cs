...
namespace tomoral.CRM.Data
{
    ...
    public class CRM_contract : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.BLL.CRM_contract cc = new tomoral.BLL.CRM_contract();
            tomoral.Model.CRM_contract model = new tomoral.Model.CRM_contract();
            ...
            if (request["Action"] == "save")
            {
                ...
                //attachment
                tomoral.BLL.CRM_contract_attachment cca = new tomoral.BLL.CRM_contract_attachment();
            ...
            if (request["Action"] == "grid")
            {
                ...
                context.Response.Write(tomoral.Common.GetGridJSON.DataTableToJSON1(ds.Tables[0], Total));
            }
            ...
            if (request["Action"] == "del")
            {
                ...
                if (canedel)
                {
                    ...
                    tomoral.BLL.CRM_contract_attachment atta = new tomoral.BLL.CRM_contract_attachment();
