...
namespace tomoral.CRM.Data
{
    ...
    public class Sys_data_authority : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            tomoral.Model.Sys_data_authority model = new tomoral.Model.Sys_data_authority();
            ...
            if (request["Action"] == "save")
            {
                ...
                foreach (AuthData authdata in _list)
                {
                    ...
                    model.Sys_option = tomoral.Common.PageValidate.InputText(authdata.Sys_option, 50);
