                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result == "false:connect") {
                            ...
                            $.ligerDialog.warn('已存在名为"' + $("#t_db_name").val() + '"的数据库,请保证此数据库下无俊逸CRM的相关表。<br/>已连接成功，可以开始配置。');
            ...
            if ($(form1).valid()) {
                ...
                $.ajax({
                    ...
                    error: function () {
                        ...
                        $.ligerDialog.error("配置失败！系统错误。<br/>1、请检查此账号是否有创建数据库的权限。<br/>2、如已创建数据库，请保证此数据库下无俊逸的相关表。<br/>3、联系俊逸技术人员解决。");
                    }  
                });  
            }
            else {
                ...
                <tr>
                    <td>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 300px; text-align: center;">
                                    <img src="../images/logo/logo.png" width="234" alt="俊逸" /></td>
                            </tr>
                        </table>
                        <table class="bodytable0" style="width: 100%; margin: -1px; line-height: 25px;">
                            ...
                            <tr>
                                <td colspan="3">如果是重新配置，请谨慎操作，以防数据丢失。</td>
                            </tr>
                        </table>
                    </td>
                </tr>
